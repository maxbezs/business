...
const Footer = () => {
  return (
    <footer className="px-6 py-12 bg-neutral-950 border-t-[1px] border-neutral-800	">
      <div class="sm:flex space-y-8 sm:space-y-0 max-w-6xl mx-auto">
        <div class="flex-1 grid grid-cols-2 gap-8 sm:flex sm:flex-col">
          <a href="/">
            <Image
              alt="max_bezs logo"
          ...
          <div class="flex flex-1 space-x-4 sm:items-end items-center">
            <a target="_blank" href="https://x.com/mintlify">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
                ...
                class="h-4 w-4 fill-gray-500 hover:fill-gray-700 dark:hover:fill-gray-300"
              >
            ...
            <div class="w-px h-4 bg-gray-100 dark:bg-white/10"></div>
            <a target="_blank" href="https://github.com/mintlify">
              <svg
                width="19"
                height="18"
                viewBox="0 0 19 18"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                class="h-[18px] w-[18px] fill-gray-500 hover:fill-gray-700 dark:hover:fill-gray-300"
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
        ...
        <div class="flex-1 grid grid-cols-2 gap-8">
          <div>
            <label class="text-gray-800 dark:text-gray-300 text-sm">
              Product
            </label>
